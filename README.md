...
Add a browser source and type as URL the
following: ```http://<ip running the python script>:<port in configuration>/live_obs_html```.
...
If you have `refresh when turning visible` on if any of the views bug out, you can activate and deactivate to force a
refresh of the page.
